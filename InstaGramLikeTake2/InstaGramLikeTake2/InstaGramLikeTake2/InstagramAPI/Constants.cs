namespace InstaGramLikeTake2
{
    ...
    class Constants
    {
        ...
        public static string AuthorizationUrl = "https://api.instagram.com/oauth/authorize/?client_id=af2caa0aeaed43f3bb97f3ae04fd272e&redirect_uri=http://instalikedev.azurewebsites.net&response_type=token";
        ...
        public static string RedirectUri = "http://instalikedev.azurewebsites.net";
    }
}
