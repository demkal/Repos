...
namespace InstaGramLikeTake2
{
    ...
    class InstagramAPI 
    {
        ...
        public static Task<string> GetMediaLikes(string mediaId)
        {
        ...
        public static Task<string> GetUserMediaSelfLiked()
        {
            return makeRequest("GET", "https://api.instagram.com/v1/users/self/media/liked");
        }
        ...
        async static Task<String> makeRequest(String command, String url)
        {
            try
            {
                string fullUrl = string.Format("{0}?access_token={1}", url, ConfigurationManager.AppSettings[Constants.InstagramAccessToken]);
